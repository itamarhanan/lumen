...
<script>
  ...
  },
  {
    id: "npm",
    label: "npm package",
    code: `npm install @lumen/analytics`,
  },
  {
    id: "server",
    label: "Server-side",
    code: `curl -X POST https://api.lumen.sh/v1/events \\
  -H "Content-Type: application/json" \\
  -d '{"site":"YOUR_SITE_ID","name":"signup"}'`,
  },
];
...
const platformIcons = [
  ...
  { name: "Custom", icon: <Globe className="size-4 stroke-[1.5]" /> },
];
...
export function IntegrationSection() {
  ...
  return (
    <section className="py-24 md:py-32 px-5 border-t border-border">
      <div className="mx-auto max-w-4xl">
        <div className="mb-10 md:mb-12">
          <span className="w-full justify-center mb-5 inline-flex items-center px-3 py-1 text-xs uppercase tracking-widest text-muted-foreground">
            Integration
          </span>
          <h2 className="text-center w-full justify-center text-3xl md:text-4xl lg:text-5xl font-semibold tracking-tight leading-snug text-balance text-foreground">
            Three ways to track
          </h2>
          <p className="mx-auto text-center w-full mt-4 text-base md:text-base text-muted-foreground leading-relaxed max-w-xl">
            Drop in a script, install a package, or hit our API. No config, no
            gatekeeping.
          </p>
        </div>
        ...
        <div className="rounded-3xl border border-border p-8 md:p-12 bg-card">
          ...
          <div className="relative">
            <div className="absolute right-4 top-4 z-10">
              <button
                onClick={copy}
                className="rounded-md border border-input bg-input/80 p-2.5 font-mono text-muted-foreground transition-colors hover:text-muted-foreground/90 hover:border-input/80"
              >
                {copied ? (
            ...
            <pre className="overflow-x-auto bg-muted/50 p-5 md:p-6 text-sm md:text-sm font-mono leading-6 text-muted-foreground">
        ...
        <div className="mt-10 rounded-3xl border border-border p-8 md:p-12 bg-card/50 text-center">
          <div className="flex flex-wrap justify-center gap-6">
            {platformIcons.map((platform) => (
              <span key={platform.name} className="text-muted-foreground">
                <span className="size-6 [&>svg]:size-full [&>svg]:stroke-[1.5] block">
                  {platform.icon}
                </span>
              </span>
            ))}
          ...
          <a
            href="#"
            className="mt-8 inline-flex items-center gap-1 text-sm font-medium text-foreground underline-offset-4 hover:underline"
          >
