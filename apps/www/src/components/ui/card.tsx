...
function Card({
  ...
  variant = "default",
  ...props
}: React.ComponentProps<"div"> & { size?: "default" | "sm"; variant?: "default" | "gold" }) {
  return (
    <div
      data-slot="card"
      data-size={size}
      ...
      className={cn(
        "group/card flex flex-col gap-6 overflow-hidden rounded-3xl py-6 text-sm has-[>img:first-child]:pt-0 data-[size=sm]:gap-4 data-[size=sm]:py-4 *:[img:first-child]:rounded-t-xl *:[img:last-child]:rounded-b-xl",
        variant === "gold"
